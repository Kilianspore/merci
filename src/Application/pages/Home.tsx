...
import moi from "../../img/projects/moi.webp";
    ...
    <div className="component home" data-testid='home-component'>
      ...
      <div className="first-container-home">
        <div className="home-container-left">
          <img src={moi} className="moi" transition-style="in:wipe:right" alt="selfie" />
          <div className="home-text-container">
            <h1 className="name">Kilian <b>Boivert</b></h1>
            <h2 className="job" transition-style="in:wipe:bottom">Étudiant en Informatique</h2>
            <p transition-style="in:wipe:right">Actuellement en 3° année de BUT Informatique en alternance, parcours réalisation d'applications</p>
            <div className="home-button-container" transition-style="in:wipe:bottom">
              ...
              <a href={cv} download='CV_Kilian_BOIVERT.pdf'><button className="classic-button white">Mon CV  <img src={download} alt="Télécharger mon CV" style={{width :"25px", marginTop: "2.5px"}} /></button></a>
            </div>
          </div>
        </div>
